...
@section('content')
	...
	<section id="staff"> 
		...
		<section class="row"> 
			<h3> Paul McGloin <small>President/Scout Team Head Coach  <em>2015-Present</em></small> </h3>
			...
			<div class="col-md-8 col-xs-12"> 
				...
				<address> 
					<i class="fa fa-envelope"></i> <a href="mailto:paul.mclgoin@sandhogsbaseball.com">paul.mclgoin@sandhogsbaseball.com</a> <br/>
		...
		<section class="row"> 
			<h3> Jon Woytach  <small> Vice-President/10u Head Coach<em>2015-Present</em></small> </h3>
			...
			<div class="col-md-8 col-xs-12 col-md-pull-4"> 
				<ul class="fa-ul hidden"> 
					<li><i class="fa-li fa fa-check"></i>More information coming soon!</li>
				</ul>

				<p> More information coming soon! </p>

				<address> 
					<i class="fa fa-envelope"></i> <a href="mailto:">Coming Soon</a> <br/>
